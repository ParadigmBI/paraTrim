...
function visualTransform(options: VisualUpdateOptions, host: IVisualHost): ParaTrimViewModel {
    ...
    ParaTrim.categorySelectionId = host.createSelectionIdBuilder()
                                    .withMeasure(categorical.values[0].source.queryName)
                                    .createSelectionId();
...
export class ParaTrim implements IVisual {
    ...
    public static categorySelectionId: ISelectionId;
    ...
    public update(options: VisualUpdateOptions) {
        ...
        this.getContextMenu(d3Select("#sandbox-host"), this.selectionManager);
    }
    ...
    private getContextMenu(svg, selection) {
        svg.on('contextmenu', () => {
            ...
            selection.showContextMenu(ParaTrim.categorySelectionId, {
